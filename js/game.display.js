game.display = {
    ...
    createClickableLayer: function (name, width, height, htmlContainer, zIndex, backgroundColor, x, y, actionOnClick) {
        var layer = Object.create(this.layer);
        ...
        layer.canvas.addEventListener('click', actionOnClick);
