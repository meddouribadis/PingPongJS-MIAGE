var game = {
    ...
    init : function() {
        ...
        this.playerOneBis.sprite = game.display.createSprite(conf.PLAYERONEWIDTH,conf.PLAYERONEHEIGHT,conf.PLAYERONEPOSX + 150, conf.PLAYERONEPOSY,"./img/playerOne.png");
        this.playerTwoBis.sprite = game.display.createSprite(conf.PLAYERTWOWIDTH,conf.PLAYERTWOHEIGHT, conf.PLAYERTWOPOSX - 150, conf.PLAYERTWOPOSY,"./img/playerTwo.png");
    ...
    displayPlayers : function() {
        ...
        game.display.drawImageInLayer(this.playersBallLayer, this.playerOneBis.sprite.img, this.playerOneBis.sprite.posX, this.playerOneBis.sprite.posY);
        game.display.drawImageInLayer(this.playersBallLayer, this.playerTwoBis.sprite.img, this.playerTwoBis.sprite.posX, this.playerTwoBis.sprite.posY);
